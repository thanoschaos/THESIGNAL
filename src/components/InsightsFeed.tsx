...
const typeConfig = {
  bullish: { dot: "bg-[#34d399]", bg: "bg-[#34d39908]" },
  bearish: { dot: "bg-[#f87171]", bg: "bg-[#f8717108]" },
  neutral: { dot: "bg-[#fbbf24]", bg: "bg-[#fbbf2408]" },
};

export default function InsightsFeed({ events }: { events: LiveEvent[] }) {
  return (
    <div className="card p-5">
      ...
      <div className="space-y-3">
        {events.map((event) => {
          ...
          return (
            <div key={event.id} className={`${cfg.bg} rounded-xl px-4 py-3 hover:bg-[#1c1f2a] transition-colors`}>
